    ...
    <main>
      <div class="container m-auto">
          <div class="flex flex-col items-center justify-center w-full bg-img">
              <h1 class="h-24 font-bold text-center text-white animate__animated animate__flip text-7xl">Happy Mother's day</h1>
              <div class="flex items-center justify-center mt-10">
                  <a href="Home.php" class="mx-5 text-2xl text-white hover:text-pink-700">Home</a>
                  <span class="mx-5 text-2xl text-white">Happy Mother's Day</span>
              </div>
          </div>
      </div>
  </main>
...
<div class="container-fluid">
    <div class="mt-20 listproduct grid grid-cols-4 gap-8">
        <?php while($row = mysqli_fetch_array($r)) { ?>
            <div class="mt-5 item">
                <img src="images/<?php echo $row['Mother_image']; ?>" class="rounded-md drop-shadow-lg w-full h-64 object-cover" style ="height: 300px;" alt="<?php echo $row['Mother_name']; ?>">
                <h2 class="mt-2 text-center"><?php echo $row['Mother_name']; ?></h2>
                <div class="text-center price">$<?php echo $row['Mother_price']; ?></div>
                <form method="POST" action="Mother'sday.php?id=<?php echo $row['Mother_id']; ?>">
                    <input type="hidden" name="images" value="images/<?php echo $row['Mother_image']; ?>">
                    <input type="hidden" name="name" value="<?php echo $row['Mother_name']; ?>">
                    <input type="hidden" name="price" value="<?php echo $row['Mother_price']; ?>">

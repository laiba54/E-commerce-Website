...
@media (max-width: 768px) {
    ...
    .navbar ul.md\\:flex-row {
        flex-direction: column; /* Ensure flex direction is column for mobile */
    }
}
</style>
                        ...
                        <ul class="flex flex-col md:flex-row md:ml-auto">
                            ...
                            <li class="relative" x-data="{ open: false }">
                             ...
                             <li class="relative" x-data="{ open: false }">
                                ...
                                <li><a class="px-4 py-2 me-3 leading-loose transition-all border-b-2 border-transparent lg:text-3xl md:text-xl md:mt-0 hover:text-pink-600 hover:border-pink-600" href="order.php"><i class="fa-solid fa-cart-shopping"></i></a></li>
